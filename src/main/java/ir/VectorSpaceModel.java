...
public class VectorSpaceModel {
	 ...
	 */
	private HashMap<Doc, HashMap<String, Double>> tfIdfWeights;
	...
	public VectorSpaceModel(Corpus corpus) {
		this.corpus = corpus;
		tfIdfWeights = new HashMap<Doc, HashMap<String, Double>>();
	...
	private void createTfIdfWeights() {
		...
		for (Doc document : corpus.getDocuments()) {
	 ...
	 */
	private double getMagnitude(Doc document) {
		double magnitude = 0;
	 ...
	 */
	private double getDotProduct(Doc d1, Doc d2) {
		double product = 0;
	 ...
	 */
	public double cosineSimilarity(Doc d1, Doc d2) {
